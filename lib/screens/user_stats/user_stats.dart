      ...
      child: Padding(
        ...
        child: StreamBuilder<List<Highscore>>(
            ...
            builder: (context, snapshot) {
              ...
              double visualHighscore =
                  snapshot.data.firstWhere((test) => test.mode == Modes.Visual).time / 1000;
              double vibrateHighscore =
                  snapshot.data.firstWhere((test) => test.mode == Modes.Vibrate).time / 1000;
              double soundHighscore =
                  snapshot.data.firstWhere((test) => test.mode == Modes.Sound).time / 1000;
              return Column(
    ...
    return Padding(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(color: Colors.black54, offset: Offset(4, 8), blurRadius: 5, spreadRadius: 2),
          ],
        ),
        child: Center(
          child: Text(
            time <= 0 ? mode + ": Null" : mode + ": " + time.toString() + " secs",
            style: TextStyle(
              color: Colors.white,
              fontSize: 30,
